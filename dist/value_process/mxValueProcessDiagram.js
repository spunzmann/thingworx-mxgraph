...
var mxGraph = mxgraph.mxGraph, mxShape = mxgraph.mxShape, mxRubberband = mxgraph.mxRubberband, mxClient = mxgraph.mxClient, mxUtils = mxgraph.mxUtils, mxCellTracker = mxgraph.mxCellTracker, mxStackLayout = mxgraph.mxStackLayout, mxLayoutManager = mxgraph.mxLayoutManager, mxConstants = mxgraph.mxConstants, mxEdgeStyle = mxgraph.mxEdgeStyle, mxRectangle = mxgraph.mxRectangle, mxEvent = mxgraph.mxEvent, mxParallelEdgeLayout = mxgraph.mxParallelEdgeLayout, mxCircleLayout = mxgraph.mxCircleLayout, mxStencilRegistry = mxgraph.mxStencilRegistry, mxStencil = mxgraph.mxStencil, mxCellEditor = mxgraph.mxCellEditor, mxKeyHandler = mxgraph.mxKeyHandler;
export function createValueProcessDiagram(container, data) {
    ...
    if (!mxClient.isBrowserSupported()) {
        ...
        var graphRenderer = new GraphCellRenderer(graph);
...
//# sourceMappingURL=mxValueProcessDiagram.js.map